...
public class FirstPersonAIO : MonoBehaviour {
    ...
    private void Update(){
        ...
        #region Look Settings - Update
            ...
            if(enableCameraMovement && !PlayerManager.instance.ingame)
        {
            float mouseYInput = 0;
            float mouseXInput = 0;
    ...
    private void FixedUpdate(){
        ...
        if(playerCanMove && !PlayerManager.instance.ingame)
        {
    ...
    public void ControllerPause(){
        PlayerManager.instance.ingame = !PlayerManager.instance.ingame;
        //controllerPauseState = !controllerPauseState; //overide by ic script PlayerManage.cs
        if(lockAndHideCursor){
            Cursor.lockState = PlayerManager.instance.ingame? CursorLockMode.None : CursorLockMode.Locked;
            Cursor.visible = PlayerManager.instance.ingame;
        }
    }
    ...
    public class FPAIO_Editor : Editor{
        ...
        public override void OnInspectorGUI(){
            ...
            if(PlayerManager.instance.ingame) {GUILayout.Label("<b><color=#B40404>Controller Paused</color></b>",new GUIStyle(GUI.skin.label){alignment = TextAnchor.MiddleCenter, richText = true, fontSize = 16});}
